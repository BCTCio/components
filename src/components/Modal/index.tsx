    ...
    <Transition.Root show={show} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block text-left align-bottom transition-all transform shadow-xl sm:align-middle sm:max-w-lg sm:w-full">
              <div className="rounded-t-lg bg-white px-4 pt-5 pb-4 sm:p-5 sm:pb-4">
